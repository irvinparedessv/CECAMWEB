          ...
          if (error.response.status === 422) {
            Swal.fire({
              ...
              text:
                ...
                "Formato de archivo no válido. Por favor, sube una imagen en formato jpeg, png o jpg.",
              allowOutsideClick: true,
            });
          } else {
            Swal.fire({
    ...
    try {
      ...
      `,
        ...
        didOpen: () => {
          ...
          const showCurrentPasswordCheckbox = document.getElementById(
            "show-current-password"
          ) as HTMLInputElement;

          showCurrentPasswordCheckbox.addEventListener("change", () => {
            currentPasswordInput.type = showCurrentPasswordCheckbox.checked
              ? "text"
              : "password";
          });
        },
      ...
      if (currentPassword) {
        ...
        if (isPasswordCorrect) {
          ...
          `,
            ...
            allowEscapeKey: false,
            didOpen: () => {
              const passwordInput1 = document.getElementById(
                "swal-input1"
              ) as HTMLInputElement;
              const passwordInput2 = document.getElementById(
                "swal-input2"
              ) as HTMLInputElement;
              const showPassword1Checkbox = document.getElementById(
                "show-password1"
              ) as HTMLInputElement;
              const showPassword2Checkbox = document.getElementById(
                "show-password2"
              ) as HTMLInputElement;

              showPassword1Checkbox.addEventListener("change", () => {
                passwordInput1.type = showPassword1Checkbox.checked
                  ? "text"
                  : "password";
              });

              showPassword2Checkbox.addEventListener("change", () => {
                passwordInput2.type = showPassword2Checkbox.checked
                  ? "text"
                  : "password";
              });
            },
          ...
          const changeSuccess = await UserService.changePassword(
            parseInt(userId, 10),
            currentPassword,
            newPwd
          );
