...
//TABLA DE PROFESSOR SIN PAGINACION DESDE EL FRONTEND
...
const totalPagesProfessor = Math.ceil(unassociatedProfessors.length / itemsPerPage);

// Calcula la lista de números de página
const pageNumbers = [];
for (let i = 1; i <= totalPagesProfessor; i++) {
  pageNumbers.push(i);
}
                ...
                <div
                  ...
                  >
                    ...
                    <Button
                      ...
                      disabled={currentPage === totalPagesProfessor}
                    >
                      <FontAwesomeIcon icon={faChevronRight} />
                    </Button>
                  </div>
